...
<head>
    ...
    <title>TRANSKOM — Login Admin</title>
            ...
            <div class="row g-0">
                <div class="col-12 col-md-5">
                    <div class="auth-left h-100">
                        ...
                        <h1>Keluar Masuk Kendaraan</h1>
                        <p>Masuk menggunakan <strong>Email atau Nama</strong> dan kata sandi Anda.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-7">
                    <div class="auth-right">
                        <div class="mb-3">
                            <div class="fw-semibold" style="font-size:16px;">Masuk Admin</div>
                            <div class="helper">Akses khusus pengelola sistem.</div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="mt-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="login" value="{{ old('login') }}"
                                    ...
                                    placeholder="contoh: admin@bapekom.go.id atau aril" required autofocus>
                                @error('login')
