@foreach ($drivers as $driver)
    <div class="modal fade" id="modalDeleteDriver-{{ $driver->id }}" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content rounded-xl border-0 shadow-lg">
                ...
                <div class="modal-body pt-2">
                    <p class="text-sm text-gray-700">
                        Apakah yakin ingin menghapus driver ini?
                    </p>
                ...
                <div class="modal-footer border-0 flex gap-2">
                    ...
                    <form action="{{ route('admin.drivers.destroy', $driver->id) }}" method="POST" class="flex-1">
                        @csrf
                        @method('DELETE')
